...
namespace xSolon.Tracing
{
    ...
    public class LogicalOperationScope : IDisposable
    {
        ...
        public LogicalOperationScope()
            : this((TraceSource)null, null, 0, 0)
        {
        }
        ...
        /// </summary>
        public LogicalOperationScope(object operationId) : this((TraceSource)null, operationId, 0, 0)
        {
        }
        ...
        public LogicalOperationScope(TraceSource source, object operationId, int startId, int stopId)
        {
            ...
            if (_source != null)
            {
                _source.TraceEvent(TraceEventType.Start, _startId, operationId.ToString());
            }
        }
